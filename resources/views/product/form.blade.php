<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('marca') }}
            {{ Form::text('productby', $product->productby, ['class' => 'form-control' . ($errors->has('productby') ? ' is-invalid' : ''), 'placeholder' => 'Marca']) }}
            {!! $errors->first('productby', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('precio') }}
